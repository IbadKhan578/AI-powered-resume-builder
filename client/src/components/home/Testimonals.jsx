...
function Testimonals() {
 const cardsData = [
    ...
    const CreateCard = ({ card }) => (
        <div id='testimonials' className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
  ...
  return (
    <div className='flex flex-col items-center my-10'>
         <div className="inline-flex items-center  gap-2 text-sm text-green-500 bg-green-400/10 border border-green-200 rounded-full px-6 py-1.5">
         <BookUserIcon width={14} />
            <span>Testimonials</span>
        </div>
        <Title title={'Dont just take our words'} description={'Hear what our users say about us. Were always looking for ways to improve. If you have a positive experience with us, leave a review.'} />
        ...
        `}</style>
            ...
            <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden mt-2 relative">
