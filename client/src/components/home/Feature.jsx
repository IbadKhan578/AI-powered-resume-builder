...
const Feature = () => {
    ...
    return (
        ...
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
                ...
                <div className="flex items-center  gap-2 text-sm text-green-500 bg-green-400/10 border border-green-200 rounded-full px-6 py-1.5">
                 <Zap width={14} />
        ...
        <Title title={'Build your resume'} description={'Our streamlined process helps you create a professional resume in minutes with intelligent AI-powered tools and features.'} />
            ...
            <div className="flex flex-col  md:flex-row -mt-3 items-center justify-center">
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Real-Time Suggestions</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Get instant AI suggestions to improve your resume as you type.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">Your personal data is fully encrypted and securely stored with 2FA protection.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">Export ATS-friendly resumes using modern, professional templates.</p>
                            </div>
                        </div>
                    </div>
                </div>
